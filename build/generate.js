...
<style>
  ...
  /* The floating orb is a mobile-only placeholder until the color-morphing
     Mandala orb replaces it — hide it on tablet/desktop widths. */
  @media(min-width:768px){#mira-orb{display:none;}}
  ...
  /* Content-aware follow-up chips, from Mira's latest reply. They live in the
     dock, flush against the top of the input, so their relationship to what you
     type is obvious. Tapping one loads it into the input to edit or send — it
     never auto-sends. Collapses to nothing when there are no suggestions. */
  .mira-chips{display:flex;flex-wrap:wrap;gap:.4rem;padding:0 .1rem;margin:0;}
...
<div class="mira-wrap">
  ...
  <div id="mira-chat" class="mira-hide">
    ...
    <div class="mira-dock">
      ...
      <!-- Content-aware follow-up chips for Mira's latest reply — sit flush above
           the input so their tie to what you type is immediate. Empty = hidden. -->
...
(function(){
  ...
  function wireChat(hasHistory, ctx){
    ...
    //
    // On return she re-greets only after a real break since your last visit or
    // message (GREET_GAP_MS) — a refresh or quick re-entry mid-session won't
    // trigger a fresh greeting every time.
