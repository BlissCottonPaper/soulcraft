...
<style>
  ...
  /* Contained navy tile (#16112D, matching the baked-in icon field so tile and
     ...
     deliberate element. */
  .mira-lantern-ico{flex:0 0 48px;width:48px;height:48px;border-radius:10px;overflow:hidden;background:#16112D;border:1px solid rgba(253,214,120,0.22);}
  .mira-lantern-ico img{display:block;width:48px;height:48px;object-fit:cover;}
...
<div class="mira-wrap">
  ...
  <!-- The Lantern — always visible, in every view, never crisis-triggered. The
       upgraded "Need a human tonight?" bar: icon + copy, opens the graded-support
       sheet (crisis lines · bandwidth check-in · therapist finder). -->
  <button class="mira-lantern-bar" id="mira-lantern-bar" type="button" aria-label="Open the Lantern — borrow a little light: check your bandwidth, find a therapist, or talk to someone. You don't have to be in crisis to reach out.">
    <span class="mira-lantern-ico" aria-hidden="true">
      <img src="/assets/lantern-48.png" srcset="/assets/lantern-48.png 1x, /assets/lantern-96.png 2x" width="48" height="48" alt="" loading="lazy" decoding="async" onerror="this.style.visibility='hidden'">
    </span>
    <span class="mira-lantern-copy">
      <strong>The Lantern — borrow a little light.</strong>
...
(function(){
  ...
  function wireLantern(){
    ...
    // The always-visible Lantern bar opens the same graded-support sheet.
